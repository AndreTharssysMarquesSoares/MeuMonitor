...
from core.exceptions.horario_atendimento_exceptions import HorarioInvalidoException, HorariosSobrepostosException, DiaSemanaInvalidoException, HorarioNaoExisteException, HorarioNaoPertenceAoMonitorException, DadosHorarioInvalidoException, SalaOcupadaException
